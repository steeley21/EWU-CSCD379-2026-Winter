    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupBooks", x => x.GBID);
                    table.ForeignKey(
                        name: "FK_GroupBooks_Books_BId",
                        column: x => x.BId,
                        principalTable: "Books",
                        principalColumn: "BId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupBooks_Groups_GroupID",
                        column: x => x.GroupID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupSchedules", x => x.GSID);
                    table.ForeignKey(
                        name: "FK_GroupSchedules_Books_BId",
                        column: x => x.BId,
                        principalTable: "Books",
                        principalColumn: "BId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGroups", x => x.UGID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupBooks_BId",
                table: "GroupBooks",
                column: "BId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupBooks_GroupID_BId",
                table: "GroupBooks",
                columns: new[] { "GroupID", "BId" },
                unique: true);
